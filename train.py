...
class PetClassifier(LightningModule):
    ...
    def training_epoch_end(self, outs):
        ...
        self.log(f"fold{self.fold}/train_criterion_epoch",
                 self.train_criterion.compute())
    ...
    def validation_epoch_end(self, outs):
        ...
        self.log(f"fold{self.fold}/valid_criterion_epoch",
                 self.valid_criterion.compute())
    ...
    def configure_optimizers(self):
        optimizer = torch.optim.AdamW(
            self.model.parameters(), lr=self.config.shd_para.lr)
...
def main(config):
    ...
    for fold in range(config.n_fold):
        ...
        earystopping = EarlyStopping(
            monitor=f"fold{fold}/valid_criterion_epoch", mode="min")
